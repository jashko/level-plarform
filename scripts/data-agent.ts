...
Хорошо: "ЦБ снизил КС до 14.25% — ставка ПФ упадёт с 6% до 4.5% при наполнении эскроу 80%"`,
    input_schema: {
      type: 'object' as const,
      properties: {
        category: {
...
✅ ХОРОШИЙ инсайт:
"КС снижена до 14.25% (19 июня). Ставка ПФ для проектов с наполнением эскроу >80% упадёт
примерно до 4-4.5%. На проект 5 млрд ₽ это экономия 75-100 млн ₽/год на обслуживании.
Следующее заседание 24 июля — вероятность снижения до 13.5% оцениваем в 55%."
